...
<body>
  <div class="page">
    ...
    <table style="width: 100%;">
      ...
      <!-- [companyname] => 株式会社ライズモアサポート [postalcode] => 〒277-0062 [address] => 千葉県柏市光が丘団地 [addressextra] => 2番1-202号 [ceoname] => 金仁今 [phone] => 04-7175-6669 [picname] => 金仁今 -->
      <tr>
        <td>件名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：{{ $data['name'] }}</td>
      ...
      <tr>
        <td>納期&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：{{ $data['duenote'] }}</td>
      </tr>
      <tr>
        <td>納入場所&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：{{ $data['placedelivery'] }}</td>
      </tr>
      <tr>
        <td>支払条件&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：{{ $data['term'] }}</td>
      </tr>
      <tr>
