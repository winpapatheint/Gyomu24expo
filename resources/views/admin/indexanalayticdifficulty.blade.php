                  ...
                  <table class="table" style="text-align: center;">
                     <thead>
                        <tr>
                          ...
                          <th scope="col">開始日</th>
                          <th scope="col">試験名</th>
                          <th style="min-width: 100px" scope="col">受験者数</th>
                        </tr>
                      </thead>
                      <tbody>
...
<!-- 
                        ...
                        <tr>
                          ...
                          <td data-label="予約者数">{{ $list->totaljoined }}</td>
                        </tr>

                        @if(!empty($list->queanalytic))
                        <tr>
                            <td colspan="6" class="unsettopborder">
                             <table class="table table-bordered">
                               @foreach( $list->queanalytic as $k => $value )
                               <tr>
                                 <td>{{ 'Q'.($loop->index+1) }}</td>
                                 <td>{{ $value->truecount ?? '0' }}</td>
                               </tr>
                              @endforeach
                             </table>
                            </td>
