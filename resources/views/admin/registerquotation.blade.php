...
<script type="text/javascript">
    ...
    $(window).on('load', function() {
      ...
      <section class="ts-contact-form">
                  ...
                  @php $action= route('registerquotation'); @endphp
                  <form id="quotation-form" class="contact-form" method="POST" action="{{ $action }}">
                  @csrf
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-10 mx-auto text-center">
                  <h3>@if (!$editmode) 新規登録 @else 見積修正 @endif</h3>
               </div><!-- col end-->
            </div>
            <div class="row">
               <div class="col-lg-10 mx-auto">
                     ...
                     <div class="row ">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <label for="gender_select"><b>見積書番号</b> <span class="badge badge-danger">必須</span></label>
                              <input class="form-control form-control-password required" placeholder="{{ __('見積書番号') }}" name="timeid" id="timeid"
                     ...
                     <div class="row ">
                        <div class="col-md-12 mx-auto">
                           <div class="form-group">
                              <label for="duenote"><b>{{ __('納期') }}</b></label>
                              <input class="form-control form-control-password" placeholder="{{ __('納期') }}" name="duenote" id="duenote"
                                 type="text" value="{{ old('duenote') ?? $data['duenote'] ?? '' }}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row ">
                        <div class="col-md-12 mx-auto">
                           <div class="form-group">
                              <label for="placedelivery"><b>{{ __('納入場所') }}</b></label>
                              <input class="form-control form-control-password" placeholder="{{ __('納入場所') }}" name="placedelivery" id="placedelivery"
                                 type="text" value="{{ old('placedelivery') ?? $data['placedelivery'] ?? '' }}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row ">
                        <div class="col-md-12 mx-auto">
                           <div class="form-group">
                              <label for="term"><b>{{ __('支払条件') }}</b></label>
                              <input class="form-control form-control-password" placeholder="{{ __('支払条件') }}" name="term" id="term"
                                 type="text" value="{{ old('term') ?? $data['term'] ?? '' }}">
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row ">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label for="duedate"><b>{{ __('見積有効期限') }}</b></label>
                              <input class="form-control form-control-password" placeholder="{{ __('見積有効期限') }}" name="duedate" id="duedate"
                                 type="date" value="{{ old('duedate') ?? $data['duedate'] ?? '' }}">
                           </div>
                        </div>
                     </div>
