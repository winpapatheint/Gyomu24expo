                     ...
                     <div class="row">
                        <div class="col-md-12 mx-auto">
                           <div class="form-group">
                              ...
                              <input class="form-control form-control-email" placeholder="件名・注文書番号" name="kword" id="kword"
                     ...
                     <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td data-label="注文書番号">{{ $list->timeid }}</td>
                          <td data-label="注文書名">{{ $list->name }}</td>
                          ...
                          <td data-label="アクション">
                              ...
                              <div class="btndiv">
                                  <a class="btnlist btn-primary" href="{{ url('/editdoc/order/'.$list->id ) }}" role="button">修正</a>
                              </div>
                              <div class="btndiv">
                                  <a class="btnlist btn-success" href="{{ url('/order/'.$list->id ) }}" target="_blank" role="button">表作成</a>
                              </div>
                              <!-- <div class="btndiv">
